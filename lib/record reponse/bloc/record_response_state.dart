...
class ReverseCountDownInProgressState extends RecordResponseState {
  ...
  const ReverseCountDownInProgressState(CameraController? cameraController, this.duration) : super(cameraController, timeElapsed: duration);
  final int duration;
  @override
...
class RecordingInProgressState extends RecordResponseState {
  ...
  const RecordingInProgressState(CameraController? cameraController,  this.duration) : super(cameraController,timeElapsed: duration);
  final int duration;
  @override
  List<Object> get props => [duration];
}
...
class RecordingCompletedState extends RecordResponseState {
  const RecordingCompletedState(CameraController? cameraController) : super(cameraController);
}
